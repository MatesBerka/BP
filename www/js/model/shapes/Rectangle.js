goog.provide('app.shapes.Rectangle');
...
app.shapes.Rectangle.prototype._generateShapePoints = function() {
    var x = 0, y = 0, z = 0;
...
app.shapes.Rectangle.prototype.isIntersection = function(ray) {
...
app.shapes.Rectangle.prototype.draw = function(ctx, callback) {
    ctx.beginPath();
...
app.shapes.Rectangle.prototype.isSelected = function(x, y) {
