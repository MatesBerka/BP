...
app.TRANSLATION = {
    'cs_CZ': {
        ...
        'wave-err-src': ', nejsou shodné vlnové délky světelných zdrojů: ',
        'wave-err-con': ' a ',
        'wave-err-end': '. Záznam nevznikl.',
        ...
        'tolerance': 'Délka koherance',
        'tolerance-title': 'Nastavit délku koherence',
        'set-tolerance': 'Délka (v cm): ',
    ...
    'en_US': {
        ...
        'wave-err-src': ', the wavelengths are not equal for light sources: ',
        'wave-err-con': ' and ',
        'wave-err-end': '. Record was not created.',
        'ref-err-ray': ', crossed coherence limit about ',
        'screen-size': 'Screen diagonal',
        'set-screen-size': 'Set diagonal (in inches): ',
        'tolerance': 'Coherence length',
        'tolerance-title': 'Set coherence length',
        'set-tolerance': 'Set length (in cm): ',
        // component configuration popup
