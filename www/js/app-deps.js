...
goog.addDependency('../../../../www/js/model/elements/HolographicPlate.js', ['app.model.HolographicPlate'], ['app.model.Component', 'app.shapes.Line'], false);
goog.addDependency('../../../../www/js/model/elements/Lens.js', ['app.model.Lens'], ['app.model.Component', 'app.shapes.Line'], false);
goog.addDependency('../../../../www/js/model/elements/Light.js', ['app.model.Light'], ['app.model.Component'], false);
goog.addDependency('../../../../www/js/model/elements/Mirror.js', ['app.model.Mirror'], ['app.model.Component', 'app.shapes.Line'], false);
goog.addDependency('../../../../www/js/model/elements/Splitter.js', ['app.model.Splitter'], ['app.model.Component', 'app.shapes.Line'], false);
goog.addDependency('../../../../www/js/model/elements/Wall.js', ['app.model.Wall'], ['app.model.Component', 'app.shapes.Rectangle'], false);
goog.addDependency('../../../../www/js/model/shapes/Line.js', ['app.shapes.Line'], ['app.shapes.Shape'], false);
goog.addDependency('../../../../www/js/model/shapes/Rectangle.js', ['app.shapes.Rectangle'], ['app.shapes.Shape'], false);
goog.addDependency('../../../../www/js/model/shapes/Shape.js', ['app.shapes.Shape'], [], false);
