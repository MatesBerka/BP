...
goog.addDependency('../www/js/controller/LightController.js', ['app.LightController'], ['app.ComponentController'], false);
goog.addDependency('../www/js/controller/MenuController.js', ['app.MenuController'], ['goog.ui.Dialog'], false);
...
goog.addDependency('../www/js/model/elements/Component.js', ['app.model', 'app.model.Component'], [], false);
goog.addDependency('../www/js/model/elements/HolographicPlate.js', ['app.model.HolographicPlate'], ['app.model.Component'], false);
goog.addDependency('../www/js/model/elements/Lens.js', ['app.model.Lens'], ['app.model.Component'], false);
goog.addDependency('../www/js/model/elements/Light.js', ['app.model.Light'], ['app.model.Component'], false);
goog.addDependency('../www/js/model/elements/Mirror.js', ['app.model.Mirror'], ['app.model.Component'], false);
goog.addDependency('../www/js/model/elements/Splitter.js', ['app.model.Splitter'], ['app.model.Component'], false);
goog.addDependency('../www/js/model/elements/Wall.js', ['app.model.Wall'], ['app.model.Component'], false);
